...
public class RedisTestAutoConfigure {
  ...
  public RedisConnectionFactory taskConnectionFactory() {
    ...
    connectionFactory
        .getPoolConfig()
        .setMaxWaitMillis(redisProperties.getConfig().getMaxWaitMillis());
    connectionFactory
        .getPoolConfig()
        .setMinEvictableIdleTimeMillis(
            Integer.parseInt(redisProperties.getConfig().getMinEvictableIdleTimeMillis()));
    connectionFactory
        .getPoolConfig()
        .setNumTestsPerEvictionRun(redisProperties.getConfig().getNumTestsPerEvictionRun());
    connectionFactory
        .getPoolConfig()
        .setTimeBetweenEvictionRunsMillis(
            Integer.parseInt(redisProperties.getConfig().getTimeBetweenEvictionRunsMillis()));
    connectionFactory
        .getPoolConfig()
        .setTestOnBorrow(redisProperties.getConfig().getTestOnBorrow());
    connectionFactory
        .getPoolConfig()
        .setTestWhileIdle(redisProperties.getConfig().getTestWhileIdle());
